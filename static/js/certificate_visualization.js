...
function processCertificates() {
    // Add display status category (valid, expiring, expired)
...
function updateStats() {
    ...
    expiredCertificatesEl.textContent = expiredCount;
}
...
function populateTable() {
    ...
    allCertificates.forEach(cert => {
        ...
        issuerCell.textContent = cert.issuer;
        row.appendChild(issuerCell);
        
        // Expiration date
        const expiresCell = document.createElement('td');
        expiresCell.textContent = formatDate(cert.valid_until);
        ...
        viewBtn.setAttribute('data-domain', cert.domain);
...
function filterCertificates() {
    ...
    const filteredCertificates = allCertificates.filter(cert => {
        ...
        if (statusValue === 'valid') {
            ...
            matchesStatus = cert.displayStatus === 'expired';
        }
...
function updateUI(filteredCertificates) {
    ...
    filteredCertificates.forEach(cert => {
        ...
        certsTable.row.add([
            ...
            daysCell,
            `<button class="btn btn-sm btn-primary view-details" data-domain="${cert.domain}">
